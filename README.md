...
The Hat Trick server is the content server for the (soon-to-be) Hat Trick sports statistics application. This application is both a reqrite and an upgrade to the SportsStats application. Hat Trick the MySportsFeeds API to gather sports statistics about professional athletes. The server uses MySportsFeeds's RESTful API architecture to deliver content such as a player's free throw percentage, where a player played college ball, and more. <a align="center" href="https://www.mysportsfeeds.com/data-feeds/api-docs/">Click here for API documentation</a>

<h4 align="center">Courtesy of the MySportsFeeds API</h4>
<p align="center">
