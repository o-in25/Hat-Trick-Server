...
module.exports = {
    ...
    getDailyPlayerStats: function(requestParams, callback) {
       if(!requestParams.hasOwnProperty('fordate')) {
           throw "Failure in request: this API call requires the 'fordate' property...";
       } else {
           // build the request
           ...
           return service.makeRequest(requestData).then((data) => {
               ...
               callback(obj.dailyplayerstats.playerstatsentry);
           }).catch((err) => {
